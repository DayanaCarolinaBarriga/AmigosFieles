                                ...
                                <div class="form-footer">
                                    <div class="text-end">
                                        <div class="d-flex">
                                            ...
                                            <button type="submit" class="btn btn-primary ms-auto ajax-submit">Crear Adoptante</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if(response.status === 'success') {
                                ...
                                alert('Hubo un problema al guardar el adoptante.');
                            }
                        },
